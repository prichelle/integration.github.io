...
![EventStreams credentials](../assets/images/eem/creds_es_ui.png)
...
Example of an AsyncAPI can be found here: [PaymentStatus.yaml](../assets/files/eem/PaymentStatus.yaml){: .text-right}.  
